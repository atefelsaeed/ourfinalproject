...
public class blight extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    void sendData(){
        ...
        String [] names = {"الحفار" , "المن","دودة ورق القطن","دودة ورق القطن الخضراء"};
        int [] imgs = {R.drawable.hfar , R.drawable.mann,R.drawable.cootonb,R.drawable.greencb};
    ...
    public void gotohome(View view) {
        Intent intent = new Intent(blight.this, navigation.class);
        startActivity(intent);
    }

//    public void gotocropsdept(View view) {
//        Intent intent = new Intent(blight.this, cropsdept.class);
//        startActivity(intent);
//    }

    public void gotoknowlegegate(View view) {
        Intent intent = new Intent(blight.this, knowlegegate.class);
        startActivity(intent);
    }

    public void gotoblight(View view) {
        Intent intent = new Intent(blight.this, blight.class);
        startActivity(intent);
    }

    public void previous(View view) {
        Intent intent = new Intent(blight.this, Main2Activity.class);
        startActivity(intent);
    }
