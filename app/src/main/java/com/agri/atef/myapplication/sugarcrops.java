...
public class sugarcrops extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sugarcrops);
    ...
    void sendData(){
        ...
        String [] names = {"قصب السكر" , "بنجر السكر"};
        int [] imgs = {R.drawable.sugarcane , R.drawable.sugarbeet};
    ...
    public void gotohome(View view) {
        Intent intent = new Intent(sugarcrops.this, navigation.class);
        startActivity(intent);
    }

//    public void gotocropsdept(View view) {
//        Intent intent = new Intent(sugarcrops.this, cropsdept.class);
//        startActivity(intent);
//    }

    public void gotoknowlegegate(View view) {
        Intent intent = new Intent(sugarcrops.this, knowlegegate.class);
        startActivity(intent);
    }

    public void gotoblight(View view) {
        Intent intent = new Intent(sugarcrops.this, blight.class);
        startActivity(intent);
    }
