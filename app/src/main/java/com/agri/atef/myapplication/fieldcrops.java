...
public class fieldcrops extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fieldcrops);
    ...
    void sendData(){
        ...
        String [] names = {"الارز" , "الذرة","القمح","الفول البلدى"};
        int [] imgs = {R.drawable.rice , R.drawable.mealies,R.drawable.wheats,R.drawable.bean};
    ...
    public void gotohome(View view) {
        Intent intent = new Intent(fieldcrops.this, navigation.class);
        startActivity(intent);
    }

//    public void gotocropsdept(View view) {
//        Intent intent = new Intent(fieldcrops.this, cropsdept.class);
//        startActivity(intent);
//    }

    public void gotoknowlegegate(View view) {
        Intent intent = new Intent(fieldcrops.this, knowlegegate.class);
        startActivity(intent);
    }

    public void gotoblight(View view) {
        Intent intent = new Intent(fieldcrops.this, blight.class);
        startActivity(intent);
    }
