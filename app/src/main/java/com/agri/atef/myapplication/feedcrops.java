...
public class feedcrops extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedcrops);
    ...
    public void gotohome(View view) {
        Intent intent = new Intent(feedcrops.this, navigation.class);
        startActivity(intent);
    }

//    public void gotocropsdept(View view) {
//        Intent intent = new Intent(feedcrops.this, cropsdept.class);
//        startActivity(intent);
//    }

    public void gotoknowlegegate(View view) {
        Intent intent = new Intent(feedcrops.this, knowlegegate.class);
        startActivity(intent);
    }

    public void gotoblight(View view) {
        Intent intent = new Intent(feedcrops.this, blight.class);
        startActivity(intent);
    }
